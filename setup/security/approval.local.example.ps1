...
$env:PERSONAL_TOOLS_APPROVAL_PAGE_URL = 'https://YOURNAME.github.io/personal-tools/setup/security/approval-page.html'
$env:PERSONAL_TOOLS_APPROVAL_TIMEOUT_SEC = '120'
